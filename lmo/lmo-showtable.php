...
if ($tabonres==2) {?>
  ...
  <tr>
    ...
    <th class="text-right"><?php echo $text[33]; ?></th>
    <th class="text-right"><?php echo $text[34]; ?></th>
<?php
if ($hidr!=1) {?>
    <th align="right"><?php echo $text[35]; ?></th>
<?php
}?>
    <th class="text-right"><?php echo $text[36]; ?></th>
<?php
if ($tabpkt==0) {?>
    <th style="width:2px;">&nbsp;</th>
    ...
    <th style="width:2px;">&nbsp;</th>
    <th style="text-align:center" colspan="3" align="center"><?php echo $text[38]; ?>&nbsp;</th>
    <th align="right"><?php echo $text[39]; ?></th><?php
// Dart Patch
if ( $ligaType == "dart") : ?>
    <th width="2">&nbsp;</th>
    <th style="text-align:center" width="2" colspan="3"><?php echo $text['dart'][7]?></th>
    <th width="2">&nbsp;</th>
...
for ($x = 1; $x <= $anzteams; $x++) {
  $stripTeam = $ligaType=="dart" ? 50 : 34;  // Dart Patch
  $i = intval(substr($tab0[$x-1], $stripTeam));  // Dart Patch

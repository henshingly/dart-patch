    ...
    if ($datei) {
        ...
        if ((substr($zeile,0,1)=="[") && (substr($zeile,-1)=="]")){
          ...
          if ($sekt=="Options"){
            ...
            if ($lmtype==0){
              ...
              if ($schl=="LigaType"){      $ligaType=$wert;}
      ...
      if ($lmtype==0){
        ...
        for ($i=0;$i<116;$i++){
          ...
          $satza[$i] = array_pad(array("_"),40,"_");  //Dart Patch
          $satzb[$i] = array_pad(array("_"),40,"_");  //Dart Patch
        ...
        for ($i=0;$i<7;$i++){
          ...
          for ($j=0;$j<64;$j++){
            ...
            $satza[$i][$j] = array_pad(array("_"),7,"_");  //Dart Patch
            $satzb[$i][$j] = array_pad(array("_"),7,"_");  //Dart Patch
...
//Dart Patch
              case "SA":
                ...
                elseif($satza[$op3][$op4]=="-1"){$satza[$op3][$op4]="_";}
              break;
              case "SB":
                $satzb[$op3][$op4]=$dum[2];
                if($satzb[$op3][$op4]==""){$satzb[$op3][$op4]=-1;}
                elseif($satzb[$op3][$op4]=="-1"){$satzb[$op3][$op4]="_";}
              break;
//Dart Patch
              case "SP":
                if ($spez==1){
...
//Dart Patch
              case "SA":
                ...
                elseif($satza[$op3][$op6][$op7]=="-1"){$satza[$op3][$op6][$op7]="_";}
              break;
              case "SB":
                $satza[$op3][$op6][$op7]=$dum[2];
                if($satza[$op3][$op6][$op7]==""){$satza[$op3][$op6][$op7]=-1;}

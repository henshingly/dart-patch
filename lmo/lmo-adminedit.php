...
// Dart Patch
  if ($ligaType == "dart") : 
    $DartLigaBreite = 4;     
  ?>
     <th colspan="<?=$DartLigaBreite;?>"> <?=$text[7020]?></td>
...
<!-- Dart Patch  -->      
     <?php if ($ligaType == "dart" ) : ?>
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[4021] ?>" class="lmo-formular-input" type="text" name="xsatza<?=$i; ?>" size="1" maxlength="4" value="<?=$satza[$st-1][$i]; ?>" tabindex="<?=$i;?>9" onChange="lmotorgte('b','<?php echo $i; ?>')" onKeyDown="lmotorclk('b','<?php echo $i; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center" width="8">:</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[4022] ?>" class="lmo-formular-input" type="text" name="xsatzb<?=$i; ?>" size="1" maxlength="4" value="<?=$satzb[$st-1][$i]; ?>" tabindex="<?=$i;?>9" onChange="lmotorgte('b','<?php echo $i; ?>')" onKeyDown="lmotorclk('b','<?php echo $i; ?>',event.keyCode)"></td>
<!-- Dart Patch  -->      
     <?php endif; 
      if($spez==1){?>
            <td width="2">&nbsp;</td>
...
<!-- Dart Patch  -->      
     <?php if ($ligaType == "dart" ) : ?>
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[4021] ?>" class="lmo-formular-input" type="text" name="xsatza<?php echo $i.$n; ?>" size="1" maxlength="4" tabindex="<?php echo $i.$n;?>7" value="<?php echo $satza[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('b','<?php echo $i.$n; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center" width="8">:</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[4022] ?>" class="lmo-formular-input" type="text" name="xsatzb<?php echo $i.$n; ?>" size="1" maxlength="4" tabindex="<?php echo $i.$n;?>8" value="<?php echo $satzb[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('b','<?php echo $i.$n; ?>',event.keyCode)"></td>
     <?php endif; ?>
<!-- Dart Patch  -->      

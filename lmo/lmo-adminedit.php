...
// Dart Patch
        ...
        if ($satza[$st-1][$i] == "" || $satza[$st-1][$i] == "_") {
          $satza[$st-1][$i] = 0;
        } else {
        ...
        if ($satzb[$st-1][$i] == "" || $satzb[$st-1][$i] == "_") {
          $satzb[$st-1][$i] = 0;
        } else {
...
// Dart Patch
         ...
         if ($satza[$st-1][$i][$n] == "" || $satza[$st-1][$i][$n] == "_") {
           $satza[$st-1][$i][$n] = 0;
         } else {
         ...
         if ($satzb[$st-1][$i][$n] == "" || $satzb[$st-1][$i][$n] == "_") {
           $satzb[$st-1][$i][$n] = 0;
         } else {
    ...
    if ($lmtype == 0) {?>
      ...
      if ($goalb[$st-1][$i]=="-1"){
        $goalb[$st-1][$i]="_";
            ...
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[109] ?>" class="lmo-formular-input" type="text" name="xgoala<?php echo $i; ?>" tabindex="<?php echo $i;?>07" size="2" maxlength="4" value="<?php echo $goala[$st-1][$i]; ?>" onChange="lmotorgte('a','<?php echo $i; ?>')" onKeyDown="lmotorclk('a','<?php echo $i; ?>',event.keyCode)"></td>
            ...
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[110] ?>" class="lmo-formular-input" type="text" name="xgoalb<?php echo $i; ?>" tabindex="<?php echo $i;?>08" size="2" maxlength="4" value="<?php echo $goalb[$st-1][$i]; ?>" onChange="lmotorgte('b','<?php echo $i; ?>')" onKeyDown="lmotorclk('b','<?php echo $i; ?>',event.keyCode)"></td>
...
<?php
      if ($ligaType == "dart" ) { ?>
                <option<?php if ($mspez[$st-1][$i]==$text['dart'][0]){echo " selected";}?>><?php echo $text['dart'][0]?></option>
                <option<?php if ($mspez[$st-1][$i]==$text['dart'][1]){echo " selected";}?>><?php echo $text['dart'][1]?></option>
<?php
      }
      else { ?>
...
?>
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[109] ?>" class="lmo-formular-input" type="text" name="xgoala<?php echo $i.$n; ?>" tabindex="<?php echo $i.$n;?>07" size="4" maxlength="4" value="<?php echo $goala[$st-1][$i][$n]; ?>" onChange="lmotorgte('a','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('a','<?php echo $i.$n; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center">
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
            ...
            <td class="lmoBackMarkierung" align="center" width="8">:</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[110] ?>" class="lmo-formular-input" type="text" name="xgoalb<?php echo $i.$n; ?>" tabindex="<?php echo $i.$n;?>08" size="4" maxlength="4" value="<?php echo $goalb[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('b','<?php echo $i.$n; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center">
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
...
?>
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[110] ?>" class="lmo-formular-input" type="text" name="xgoalb<?php echo $i.$n; ?>" tabindex="<?php echo $i.$n;?>07" size="4" maxlength="4" value="<?php echo $goalb[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('b','<?php echo $i.$n; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center">
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td><script type="text/javascript">document.write('<a href="#" onclick="lmotorauf(\'b\',\'<?php echo $i.$n; ?>\',1);return false;" title="<?php echo $text[121]; ?>" onMouseOver="lmoimg(\'<?php echo $i.$n; ?>f\',img1)" onMouseOut="lmoimg(\'<?php echo $i.$n; ?>f\',img0)"><img src="<?php echo URL_TO_IMGDIR?>/lmo-admin0.gif" name="ximg<?php echo $i.$n; ?>f" width="7" height="7" border="0"><\/a>')</script></td>
            ...
            <td class="lmoBackMarkierung" align="center" width="8">:</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text[109] ?>" class="lmo-formular-input" type="text" name="xgoala<?php echo $i.$n; ?>" tabindex="<?php echo $i.$n;?>08" size="4" maxlength="4" value="<?php echo $goala[$st-1][$i][$n]; ?>" onChange="lmotorgte('a','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('a','<?php echo $i.$n; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center">
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td><script type="text/javascript">document.write('<a href="#" onclick="lmotorauf(\'a\',\'<?php echo $i.$n; ?>\',1);return false;" title="<?php echo $text[120]; ?>" onMouseOver="lmoimg(\'<?php echo $i.$n; ?>a\',img1)" onMouseOut="lmoimg(\'<?php echo $i.$n; ?>a\',img0)"><img src="<?php echo URL_TO_IMGDIR?>/lmo-admin0.gif" name="ximg<?php echo $i.$n; ?>a" width="7" height="7" border="0"><\/a>')</script></td>
...
<?php
        if ($ligaType == "dart" ) : ?>
            <td width="2">&nbsp;</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text['dart'][21] ?>" class="lmo-formular-input" type="text" name="xsatza<?php echo $i.$n; ?>" size="1" maxlength="4" tabindex="<?php echo $i.$n;?>7" value="<?php echo $satza[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('b','<?php echo $i.$n; ?>',event.keyCode)"></td>
            <td class="lmoBackMarkierung" align="center" width="8">:</td>
            <td class="lmoBackMarkierung" align="right"><input title="<?php echo $text['dart'][22] ?>" class="lmo-formular-input" type="text" name="xsatzb<?php echo $i.$n; ?>" size="1" maxlength="4" tabindex="<?php echo $i.$n;?>8" value="<?php echo $satzb[$st-1][$i][$n]; ?>" onChange="lmotorgte('b','<?php echo $i.$n; ?>')" onKeyDown="lmotorclk('b','<?php echo $i.$n; ?>',event.keyCode)"></td>
<?php
        endif;
?>
<!-- Dart Patch  -->
...
<?php
      if ($ligaType == "dart" ) { ?>
                <option<?php if ($mspez[$st-1][$i][$n]==$text['dart'][0]){echo " selected";}?>><?php echo $text['dart'][0]?></option>
                <option<?php if ($mspez[$st-1][$i][$n]==$text['dart'][1]){echo " selected";}?>><?php echo $text['dart'][1]?></option>
<?php
      }
      else { ?>

...
$xligaType=isset($_POST['xligaType'])?$_POST['xligaType']:"";  //Dart Patch
...
if ($newpage<3){ ?>
  ...
  if ($newpage>0){ ?>
        ...
        <input type="hidden" name="xligaType" value="<?php echo $xligaType; ?>"><?php  //Dart Patch
  }
  if ($newpage>1){ ?>
          ...
          <tr>
            ...
            <td class="nobr" align="left"><acronym title="<?php echo $text['dart'][23] ?>">
              <select class="lmo-formular-input" name="xligaType" onChange="dolmoedit()">
                ...
                <option value="handball"<?php if ($xligaType==2) echo " selected";?>><?php echo $text[1004]?></option>
                <option value="fussball"<?php if ($xligaType==3) echo " selected";?>><?php echo $text[1005]?></option>
                <option value="eishockey"<?php if ($xligaType==4) echo " selected";?>><?php echo $text[1006]?></option>
                <option value="volleyball"<?php if ($xligaType==5) echo " selected";?>><?php echo $text[2000]?></option>
              </select></acronym></td>
          </tr> 
<!-- Dart Patch -->
          <tr>
